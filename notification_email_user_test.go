...
func TestEmailUserTemplatingCustomPrefixAndSuffixInContent(t *testing.T) {
	layout := "2006-01-02T15:04:05.000Z"
	fakeBuildTimestamp, _ := time.Parse(layout, "2022-12-31T13:10:00.000Z")
	...
	result := templateUserEmailBodyContent(tmp, "./test/email_content_prefix.tpl", "./test/email_content_suffix.tpl")
	//log.Println(result.String())
